...
public class Content implements java.io.Serializable
{
	...
	/** full constructor */
	public Content(Long id, UserInfo userInfo, Timestamp conPubTime, Integer conZan, Integer conHot,
			String conTitle, Integer conPls, Integer conTypeId, String conImageUrl, String conSummary,
			Set praises, Set wenZhangs, Set pingLuns, Set losts, Set erShous, Set diaries, Set images,
			Set collections)
	{
		this.id = id;
