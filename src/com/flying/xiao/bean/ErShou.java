...
public class ErShou implements java.io.Serializable
{
	...
	private Set erShouImages = new HashSet(0);
	...
	/** full constructor */
	public ErShou(Long esId, ErShouType erShouType, ErShouGoodsType erShouGoodsType, Content content,
			String esMiaoshu, Double esPrice, Double esNewPrice, String esChengse, String esPhone,
			String esName, Set erShouImages)
	{
		this.esId = esId;
		...
		this.esName = esName;
		this.erShouImages = erShouImages;
	}
	...
	public Set getErShouImages()
	{
		return this.erShouImages;
	}

	public void setErShouImages(Set erShouImages)
	{
		this.erShouImages = erShouImages;
	}
