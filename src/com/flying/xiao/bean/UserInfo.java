...
public class UserInfo implements java.io.Serializable
{
	...
	/** full constructor */
	public UserInfo(Long id, String userName, String userPsd, String userGerenshuoming, String userRealName,
			Boolean userSex, String userHeadImageUrl, String userQq, String userEmail, Integer userTypeId,
			Integer userJifen, Integer userFuns, Boolean userIsQiandao, String userPhone,
			Set messagesForMsgUserId, Set friendsForUserFriendBelongUserId, Set contents,
			Set friendsForUserId, Set collections, Set praises, Set messagesForMsgFromUserId, Set pingLuns)
	{
		this.id = id;
